...
This table records how historical WANem documentation aligns with the current local WANem Beta 3.0.3 tree.

| Topic | Historical source | Historical version context | Verified in 3.0.3? | Status | Notes |
|---|---|---:|---|---|---|
...
| Save/Restore available in next release | WANemv11-Setup-Guide.pdf | 1.1 | Yes | Conflicts with 3.0.3 | Current tree already includes `save-restore.php`, `download.php`, and `upload.php`. |
...
| WANem Beta 3.0.3 repository baseline | top-level historical mirror README | Beta 3.0.3 | Yes | Confirmed | Documented in preserved mirror README and existing git history. |
